#+NAME: Exercise Directory
* 3/4 Sit-Up
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: abdominals
  :END:
...
* Alternating Cable Shoulder Press
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: shoulders
  :END:
...
* Alternating Hang Clean
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: hamstrings
  :END:
...
* Alternating Kettlebell Row
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: middle back
  :END:
...
* Band Hip Adductions
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: adductors
  :END:
...
* Barbell Deadlift
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: lower back
  :END:
...
* Monster Walk
  :PROPERTIES:
  :ORG_FIT_MUSCLE_GROUP: abductors
  :END:
